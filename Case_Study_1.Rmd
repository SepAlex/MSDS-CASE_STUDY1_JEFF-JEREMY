...
#kable(BrewbyState, align="c", padding=0, caption = "Quantity of Breweries by State",format="markdown")
kable(BrewbyStateS, format = "Rmarkdown", caption = "Demo table", booktabs = T) %>%
...
kable(head(BrewMerged,6), align="c", caption = "Table 1.2a BrewMerged Dataset First 6 Observations",format="markdown")
```
```{r, last6}
# Last 6 Brewery Observations
kable(head(BrewMerged,6), align="c", caption = "Table 1.2b BrewMerged Dataset Last 6 Observations",format="markdown")
```
...
kable(ABVmax[,c(4,2,5,7)], align="c", title = "State with Maximum alcohol content (ABV) beer",format="markdown")
